     ...
     return (
          <div>
               <div className='h-20 bg-pp-dark flex items-center justify-between px-10 max-sm:px-3'>
                    ...
                    <div className='flex '>
                         <button className=' h-7 p-3 max-sm:mx-2 mx-6 bg-white bg-opacity-70 rounded-md  flex items-center font-semibold max-sm:text-xs'>
                         ...
                         <button className=' h-7 p-3 bg-white opacity-70 rounded-md flex items-center font-semibold max-sm:text-xs '>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 max-sm:block hidden">
