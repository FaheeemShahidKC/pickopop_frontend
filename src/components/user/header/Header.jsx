     ...
     return (
          <div className='z-10 '>
               <div className='h-20 bg-pp-dark flex items-center justify-between px-10 max-sm:px-3'>
                    ...
                    <div className='flex '>
                         <button onClick={() => { navigate('/') }} className='hover:bg-pp-dark h-7 p-3 max-sm:mx-1 mx-2 bg-pp-gray-3 bg-opacity-70 rounded-md  flex items-center font-semibold max-sm:text-xs'>
                         ...
                         <button onClick={() => { navigate('/picker/register') }} className='hover:bg-pp-dark h-7 p-3 bg-pp-gray-3 max-sm:mx-1 mx-2 opacity-70 rounded-md flex items-center font-semibold max-sm:text-xs '>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 max-sm:block hidden">
