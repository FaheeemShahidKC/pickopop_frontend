     ...
     return (
          <div className='h-screen w-1/6 bg-black'>
               <div className="p-4 text-white borde">
                    <h1 className="text-2xl font-semibold max-sm:hidden max-md:hidden font- text-center" >k</h1>
                    <ul className="mt-10 flex-col text-center">
                         ...
                         <li onClick={()=>{navigate('/admin/userManagement')}} className=" p-2 py-3 mb border-x-0 border-gray hover:bg-added-grey-900 cursor-pointer border-t-0 border flex ">
                              <div className='mr-4'>
                                   <FontAwesomeIcon icon={faBook}></FontAwesomeIcon>
                              </div>
                              <p className="block cursor-pointer hover:text-indigo-400 max-sm:hidden max-md:hidden">
