          ...
          <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div className="max-w-md mx-auto">
              <div className='text-center'>
                <h1 className="sm:text-3xl text-2xl font-extrabold text-pp-dark font-mono">Pick'O'Pop</h1>
              </div>
            ...
            <div className="w-full flex-row justify-center">
              <p className='text-xs px-1 py-1'>Already have an account?<span onClick={() => { navigate('/login') }} className='text-blue cursor-pointer'>Login.</span></p>
